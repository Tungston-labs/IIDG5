...
const EditBulkCertificate = (props) => {
    ...
    useEffect(() => {
        const getCertificateData = async () => {
            try {
                const response = await axios.get(`https://iidglabs.com/api/auth/certificate/bulk-certificates/${props.id}`);
                ...
                const imageResponse = await axios.get(`https://iidglabs.com/api/auth/certificate/bulk-certificate-photo/${props.id}`, {
    ...
    const handleImageChange = (e) => {
        ...
        if (file) {
            setImage(file);
            setExistingImage(URL.createObjectURL(file)); // Immediately preview the selected image
        }
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://iidglabs.com/api/auth/certificate/update-bulkcertificate/${props.id}`, formData, {
                headers: {
