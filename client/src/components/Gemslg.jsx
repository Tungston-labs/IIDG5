...
const DropdownContent = ({ gem }) => {
  ...
  return (
        ...
        <div className="col-span-2 py-2 px-6  border-dashed border-t border-b flex-col justify-between border-[#99a8bf] bg-[#f3f4f7]">

            {/* ---- image ---- */}
            <div className='pt-5 px-4'>
                <img src={content[gem].image} alt='img' className='w-[11rem] mt-4 mx-auto max-md:w-[8rem]'/>
                <p className='text-[#33517f] font-mes text-center mt-8 font-bold text-[2.3rem] max-md:text-[2rem]'>{content[gem].title}</p>

            </div>

            {/* ---- description ---- */}
            <div className='py-5 text-center px-4 w-full '>
                <p className='text-[1.2rem] font-urban text-[#33517f] text-center max-md:text-[1rem]'>{content[gem].description}</p>
            </div>
            ...
            <div className='py-5  px-4 w-full'>
                ...
                <p className='text-[1.2rem] font-urban text-center text-[#33517f] font-light max-md:text-[1rem]'>{content[gem].facts}</p>
            </div>
        </div>
  )
};
...
<>
    ...
    <div className=' grid grid-cols-2 '>
        ...
        {/* ------------------------------------------------- BOX-1 ----------------------------------------------------------- */}
        <div className={`py-5 px-12 max-md:px-6 max-md:py-3 border-dashed border border-[#99a8bf] border-t-0 border-l-0 border-r-0 ${active === 'coral' ? 'bg-[#f3f4f7]' : 'bg-white'}`} onClick={()=> handleActive('coral')}>
            <div className='text-[#33517f] font-mes text-[1.8rem] text-center py-4 max-md:text-[1.3rem] max-sm:leading-5 max-md:leading-6 max-md:py-0  tracking-wide'>Coral</div>
            <div><img src={gem1} alt='gem' className={`w-[7rem] max-md:w-[4rem] py-5 max-md:py-2 drop-shadow-lg  mx-auto  ${active === 'coral' ? 'scale-90' : ''}`}/></div>
        </div>


        {/* ------------------------------------------------- BOX-2 ----------------------------------------------------------- */}
        
        <div className={`py-5 px-12 max-md:px-6 max-md:py-3 border-dashed border border-[#99a8bf] border-t-0 border-r-0 ${active === 'hessonite' ? 'bg-[#f3f4f7]' : 'bg-white'}`} onClick={()=> handleActive('hessonite')}>
            <div className='text-[#33517f] font-mes text-[1.8rem] text-center py-4 max-md:text-[1.3rem] max-sm:leading-5 max-md:leading-6 max-md:py-0  tracking-wide'>Hessonite Garnet</div>
            <div><img src={gem2} alt='gem' className={`w-[7rem] max-md:w-[4rem] py-5 max-md:py-2 drop-shadow-lg  mx-auto  ${active === 'hessonite' ? 'scale-90' : ''}`}/></div>
        </div>

        {/*-------------------- BOX 1 2  DROPDOWN HERE ---------------- */}
        {active === 'coral' && <DropdownContent gem='coral'/>}
        {active === 'hessonite' && <DropdownContent gem='hessonite'/>}


        {/* ------------------------------------------------- BOX-3 ----------------------------------------------------------- */}
        <div className={`py-5 px-12 max-md:px-6 max-md:py-3 border-dashed border border-[#99a8bf] border-t-0  border-l-0 border-r-0  ${active === 'lehsunia' ? 'bg-[#f3f4f7]' : 'bg-white'}`} onClick={()=> handleActive('lehsunia')}>
            <div className='text-[#33517f] font-mes text-[1.8rem] text-center py-4 max-md:text-[1.3rem] max-sm:leading-5 max-md:leading-6 max-md:py-0  tracking-wide'>Chrysoberyl Cat's Eye</div>
            <div><img src={gem3} alt='gem' className={`w-[7rem] max-md:w-[3.4rem] py-5 max-md:py-2 drop-shadow-lg  mx-auto  ${active === 'lehsunia' ? 'scale-90' : ''}`}/></div>
        </div>


        {/* ------------------------------------------------- BOX-4 ----------------------------------------------------------- */}
        <div className={`py-5 px-12 max-md:px-6 max-md:py-3 border-dashed border border-[#99a8bf] border-t-0  border-r-0 ${active === 'pearl' ? 'bg-[#f3f4f7]' : 'bg-white'}`} onClick={()=> handleActive('pearl')}>
            <div className='text-[#33517f] font-mes text-[1.8rem] text-center py-4 max-md:text-[1.3rem] max-sm:leading-5 max-md:leading-6 max-md:py-0  tracking-wide'>Pearl</div>
            <div><img src={gem4} alt='gem' className={`w-[7rem] max-md:w-[4rem] py-5 max-md:py-2 drop-shadow-lg  mx-auto  ${active === 'pearl' ? 'scale-90' : ''}`}/></div>
        </div>

        {/*-------------------- BOX 3 4 DROPDOWN HERE ---------------- */}
        {active === 'lehsunia' && <DropdownContent gem='lehsunia'/>}
        {active === 'pearl' && <DropdownContent gem='pearl'/>}


        {/* ------------------------------------------------- BOX-5 ----------------------------------------------------------- */}
        <div className={`py-5 px-12 max-md:px-6 max-md:py-3 border-dashed border border-[#99a8bf] border-t-0 border-l-0  border-r-0 ${active === 'emerald' ? 'bg-[#f3f4f7]' : 'bg-white'}`} onClick={()=> handleActive('emerald')}>
            <div className='text-[#33517f] font-mes text-[1.8rem] text-center py-4 max-md:text-[1.3rem] max-sm:leading-5 max-md:leading-6 max-md:py-0  tracking-wide'>Emerald</div>
            <div><img src={gem5} alt='gem' className={`w-[7rem] max-md:w-[4rem] py-5 max-md:py-2 drop-shadow-lg  mx-auto  ${active === 'emerald' ? 'scale-90' : ''}`}/></div>
        </div>


        {/* ------------------------------------------------- BOX-6 ----------------------------------------------------------- */}
        <div className={`py-5 px-12 max-md:px-6 max-md:py-3 border-dashed border border-[#99a8bf] border-t-0 border-r-0  ${active === 'ruby' ? 'bg-[#f3f4f7]' : 'bg-white'}`} onClick={()=> handleActive('ruby')}>
            <div className='text-[#33517f] font-mes text-[1.8rem] text-center py-4 max-md:text-[1.3rem] max-sm:leading-5 max-md:leading-6 max-md:py-0  tracking-wide'>Ruby</div>
            <div><img src={gem6} alt='gem' className={`w-[7rem] max-md:w-[4rem] py-5 max-md:py-2 drop-shadow-lg  mx-auto ${active === 'ruby' ? 'scale-90' : ''}`}/></div>
        </div>

        {/*-------------------- BOX 5 6 DROPDOWN HERE ---------------- */}
        {active === 'emerald' && <DropdownContent gem='emerald'/>}
        {active === 'ruby' && <DropdownContent gem='ruby'/>}

        {/* ------------------------------------------------- BOX-7 ----------------------------------------------------------- */}
        <div className={`py-5 px-12 max-md:px-6 max-md:py-3 border-dashed border border-[#99a8bf] border-t-0 border-l-0  border-r-0 ${active === 'bluesapphire' ? 'bg-[#f3f4f7]' : 'bg-white'}`} onClick={()=> handleActive('bluesapphire')}>
            <div className='text-[#33517f] font-mes text-[1.8rem] text-center py-4 max-md:text-[1.3rem] max-sm:leading-5 max-md:leading-6 max-md:py-0  tracking-wide'>Blue Sapphire</div>
            <div><img src={gem7} alt='gem' className={`w-[7rem] max-md:w-[4rem] py-5 max-md:py-2 drop-shadow-lg  mx-auto  ${active === 'bluesapphire' ? 'scale-90' : ''}`}/></div>
        </div>


        {/* ------------------------------------------------- BOX-8  ----------------------------------------------------------- */}
        <div className={`py-5 px-12 max-md:px-6 max-md:py-3 border-dashed border border-[#99a8bf] border-t-0 border-r-0 ${active === 'yellowsapphire' ? 'bg-[#f3f4f7]' : 'bg-white'}`} onClick={()=> handleActive('yellowsapphire')}>
            <div className='text-[#33517f] font-mes text-[1.8rem] text-center py-4 max-md:text-[1.3rem] max-sm:leading-5 max-md:leading-6 max-md:py-0  tracking-wide'>Yellow Sapphire</div>
            <div><img src={gem8} alt='gem' className={`w-[7rem] max-md:w-[4rem] py-5 max-md:py-2 drop-shadow-lg  mx-auto  ${active === 'yellowsapphire' ? 'scale-90' : ''}`}/></div>
        </div>

        {/*-------------------- BOX 7 8  DROPDOWN HERE ---------------- */}
    ...
    <div className='flex justify-center flex-col'>
        <div className={`py-5 px-12 max-md:px-6 max-md:py-3  border-dashed border border-[#99a8bf] border-t-0 border-r-0  border-l-0 ${active === 'diamond' ? 'bg-[#f3f4f7]' : 'bg-white'}`} onClick={()=> handleActive('diamond')}>
            <div className='text-[#33517f] font-mes text-[1.8rem] text-center py-4 max-md:text-[1.3rem] max-sm:leading-5 max-md:leading-6 max-md:py-0  tracking-wide'>Diamond</div>
            <div><img src={gem9} alt='gem' className={`w-[7rem] max-md:w-[4rem] py-5 max-md:py-2 drop-shadow-lg  mx-auto  ${active === 'diamond' ? 'scale-90' : ''}`}/></div>
        </div>
